...
export type SubCategoryWithCategoryType = Awaited<ReturnType<
...
// Store product
export type StoreProductType = Awaited<ReturnType<
  typeof getAllStoreProducts
>>[0];

// Store default shipping details
export type StoreDefaultShippingType = Awaited<ReturnType<
...
export type ProductType = Awaited<ReturnType<
  typeof getProducts
>>["products"][0];

export type ProductWishlistType = Awaited<ReturnType<
...
export type ProductPageType = Awaited<ReturnType<
  typeof retrieveProductDetails
>>;

export type ProductPageDataType = Awaited<ReturnType<
